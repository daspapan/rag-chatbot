...
import { BatchWriteCommandInput, DynamoDBDocumentClient, QueryCommand } from '@aws-sdk/lib-dynamodb'
...
// ---- Export AWS Clients ----
export { dynamodb, ddbDocClient, s3, bedrockAgent, bedrockAgentRuntime }
